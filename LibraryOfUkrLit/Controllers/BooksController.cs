...
namespace LibraryOfUkrLit.Controllers
{
    public class BooksController : Controller
    {
        ...
        public BooksController(Authorship context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BooksID,Name,Year")] Books books)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BooksID,Name,Year")] Books books)
        {
            if (id != books.BooksID)
            {
                return NotFound();
